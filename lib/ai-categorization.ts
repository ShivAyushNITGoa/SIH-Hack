...
// This simulates AI analysis using pattern matching and keyword analysis
...
export function analyzeIssue(title: string, description: string): IssueAnalysis {
...
export function analyzeIssues(issues: Array<{title: string, description: string}>): IssueAnalysis[] {
  return issues.map(issue => analyzeIssue(issue.title, issue.description));
}
