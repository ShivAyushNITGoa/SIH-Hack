        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              <label className="text-xs text-gray-600">Within (km)</label>
              <input type="range" min={0} max={20} step={1} value={distanceKm} onChange={(e) => setDistanceKm(Number(e.target.value))} />
