...
export default function DownloadsPage() {
  ...
  const webApps = [
    {
      name: "NagarSetu Admin Dashboard",
      description: "NagarSetu's comprehensive administrative interface for managing civic issues",
      url: "/dashboard",
      icon: Shield,
      color: "blue",
      features: ["Issue Management", "Analytics", "User Management", "Reports"]
    },
    {
      name: "NagarSetu Citizen Portal",
      description: "NagarSetu's user-friendly interface for citizens to report and track issues",
      url: "/citizen",
      icon: Users,
      color: "green",
      features: ["Issue Reporting", "Progress Tracking", "Community Map", "Profile"]
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              Download <span className="gradient-text">NagarSetu</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Get NagarSetu on your preferred platform. Available for mobile devices, web browsers, 
              and as progressive web apps for the best experience.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Access NagarSetu directly from your web browser - no installation required.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              NagarSetu works on all modern web browsers with the latest features.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Follow these simple steps to get started with NagarSetu.
            </p>
          </div>
