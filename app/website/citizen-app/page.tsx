...
export default function CitizenAppPage() {
  ...
  const issueTypes = [
    { name: "Infrastructure", icon: MapPin, color: "blue", examples: ["Roads", "Bridges", "Buildings"] },
    { name: "Environment", icon: Globe, color: "green", examples: ["Pollution", "Waste", "Trees"] },
    { name: "Safety", icon: AlertTriangle, color: "red", examples: ["Street Lights", "Traffic", "Security"] },
    { name: "Transport", icon: Users, color: "purple", examples: ["Public Transport", "Parking", "Traffic"] },
    { name: "Utilities", icon: CheckCircle, color: "orange", examples: ["Water", "Electricity", "Internet"] }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              NagarSetu <span className="gradient-text">Citizen Portal</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              NagarSetu's gateway to civic engagement. Report issues, track progress, and make your voice heard in your community. 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Track all your reported issues and community engagement in one place.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-900 rounded-2xl p-6 shadow-2xl">
              <div className="bg-white rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {[
                    { title: "Broken Street Light", status: "In Progress", time: "2 days ago" },
                    { title: "Pothole on Main Road", status: "Resolved", time: "1 week ago" },
                    { title: "Garbage Collection", status: "Pending", time: "3 days ago" }
                  ].map((issue, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join thousands of citizens already using NagarSetu to improve their communities.
          </p>
